...
1. GitHub Is the Only Official Distribution Source
   ...
   Google Drive, Dropbox, npm, Figma Community, or other repositories.
   All distribution must originate from this official GitHub repository.

2. No Derivatives
   You may not alter, remix, recolor, or create modified versions of
   these Assets and distribute them.

3. No Standalone Commercial Distribution
   You may not sell, sublicense, or distribute these Assets as a
   standalone product, icon pack, or asset bundle where the Assets
   themselves constitute the primary commercial value.
...
一、GitHub 為唯一合法散布來源
    ...
    至任何其他平台，包含但不限於：
    Google Drive、Dropbox、npm、Figma Community 或其他儲存庫。
    所有散布行為須源自本官方 GitHub 儲存庫。

二、禁止改作散布
    不得對本圖示資產進行修改、混搭、重新上色，
    或將任何改作版本對外散布。

三、禁止單獨商業販售
    不得將本圖示資產以獨立商品、圖示包或素材包的形式
    進行販售、轉授權或散布。
